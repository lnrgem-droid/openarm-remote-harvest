...
lerobot-record \
  ...
  --robot.cameras='{cam_left: {type: opencv, index_or_path: "/dev/video6", width: 640, height: 480, fps: 30}, cam_right: {type: opencv, index_or_path: "/dev/video14", width: 640, height: 480, fps: 30}, cam_head: {type: opencv, index_or_path: "/dev/video24", width: 640, height: 480, fps: 30}}' \
  --teleop.type=openarm_bridge_teleop \
  --dataset.repo_id=local/openarm_task \
  --dataset.root=/home/nvidia/openarm_robot/datasets/openarm_task \
